...
sudo sed -i 's+download.docker.com+mirrors.tuna.tsinghua.edu.cn/docker-ce/docker-ce+' /etc/yum.repos.d/docker-ce.repo
# sudo sed -i 's+download.docker.com+mirrors.aliyun.com/docker-ce/docker-ce+' /etc/yum.repos.d/docker-ce.repo
# sudo sed -i 's+download.docker.com+mirrors.cloud.aliyuncs.com/docker-ce/docker-ce+' /etc/yum.repos.d/docker-ce.repo
